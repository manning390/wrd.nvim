...
local actions = require("telescope._extensions.wrd.actions")
...
function wrd.setup(opts)
	wrd.mappings = vim.tbl_deep_extend("force", default_mappings, opts.mappings or {})
end
